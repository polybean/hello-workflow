...
// NewClientBuilder creates a new builder object
func NewClientBuilder(logger *zap.Logger) *WorkflowClientBuilder {
...
func (b *WorkflowClientBuilder) build() error {
	...
	ch, err := tchannel.NewChannelTransport(tchannel.ServiceName(_cadenceClientName))
